...
void c_add(void){
    ...
    c2.real = 0;
    c2.imaginary = 0;
    TEST_ASSERT_EQUAL(SUCCESS, csum(&c1, &c2, &result));
...
void c_sub(void){
    ...
    c2.real = 0;
    c2.imaginary = 0;
    TEST_ASSERT_EQUAL(SUCCESS, cdiff(&c1, &c2, &result));
    TEST_ASSERT_EQUAL(0, result.real);
    TEST_ASSERT_EQUAL(0, result.imaginary);        
...
void c_mul(void){
    ...
    c2.real = 0;
    c2.imaginary = 0;
    TEST_ASSERT_EQUAL(SUCCESS, cmul(&c1, &c2, &result));
    TEST_ASSERT_EQUAL(0, result.real);
    TEST_ASSERT_EQUAL(0, result.imaginary);
...
void c_div(void){
    ...
    c4.real = 0;
    c4.imaginary = 0;
    TEST_ASSERT_EQUAL(ERROR_DIV_BY_ZERO, cdiv(&c3, &c4, &result));
    TEST_ASSERT_EQUAL(0, result.real);
    TEST_ASSERT_EQUAL(0, result.imaginary);
    ...
    c4.real = 75;
    c4.imaginary = 95;
    TEST_ASSERT_EQUAL(SUCCESS, cdiv(&c3, &c4, &result));
